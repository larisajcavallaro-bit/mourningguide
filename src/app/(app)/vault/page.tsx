...
const AREAS = [
  ...
  ['Business interests', 'Ownership, partnerships, shares', '/vault/finances?category=other'],
  ...
  ['Subscriptions & services', 'Streaming, phone, memberships', '/vault/finances?category=other'],
  ['Utilities & home services', 'Electric, gas, water, internet', '/vault/finances?category=other'],
  ['Pets', 'Vet, care instructions, new home', '/vault/finances?category=other'],
  ['Special items & sentimental', 'Jewelry, art, heirlooms', '/vault/finances?category=other'],
...
export default async function VaultOverviewPage() {
  ...
  return (
    <AppShell title="Personal" active="vault">
      <h1 className="page-heading">Your planning areas</h1>
